      ...
      <div class="ultrabackground">
        ...
        <div class="title">
          <NavLink to="/Fitoterapia">
            <img src={Sec1} alt="Fitoterapia" className="img-fluid" width="150px" />
        ...
        <div class="title">
          <NavLink to="/Obtencion">
            <img src={Sec2} alt="Obtencion" className="img-fluid" width="150px" />
            <h7 className='text-2xl mt-2'>Más info</h7>
          </NavLink>
        </div>
        ...
        <div class="title">
          <NavLink to="/Recoleccion">
            <img src={Sec3} alt="Recoleccion" className="img-fluid" width="150px" />
            <h7 className='text-2xl mt-2'>Más info</h7>
          </NavLink>
        </div>
      </div>
